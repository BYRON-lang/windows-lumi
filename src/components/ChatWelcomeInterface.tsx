...
interface ChatWelcomeInterfaceProps {
  onMessageSent?: (message: string) => void;
}

export default function ChatWelcomeInterface({ onMessageSent }: ChatWelcomeInterfaceProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{ height: '50%', padding: '8px', display: 'flex', alignItems: 'center', gap: 8 }}>
